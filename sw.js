...
const SHELL = [
  ...
  /* the chart's candle bodies — on screen from the moment the chart opens */
  "./assets/chart/candle-bull@2x.png",
  "./assets/chart/candle-bear@2x.png",
